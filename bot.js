...
client.on("message", message => {
   ...
   =================
   $color {number} | to change the color
   =================
   $contact {msg} | to send a dm to the bot owner
   =================
   `)
...
client.on("message", message => {
   ...
   =================
   $cr-color | to creat 50 colors
   =================
   $del-colors | to delete 50 colors
   =================
   `)
...
client.on('message', message => {
    if (message.content === "$server") {
        ...
        var embed = new Discord.RichEmbed()
            ...
            .addField("**✅ main chat**", "**" + message.guild.DefaultChannel + "**", true)
            .addField("**🌍 location**", "**" + message.guild.region + "**", true)
            .addField('**💬 count of chatting rooms **', `**[ ${message.guild.channels.filter(m => m.type === 'text').size} ] Channel **`, true)
            .addField("**📢voice channels count**", ` ** [ ${message.guild.channels.filter(m => m.type === 'voice').size} ] Channel ** `, true)
            .addField("**🤔 for how long has been the server up for **", ` ** [ ${days.toFixed(0)} ] ** Day `, true)
            .addField("**👔 roles**", `**[${message.guild.roles.size}]** Role `, true)
            .addField("**💠 server protection lvl**", ` ** [ ${verificationLevels[message.guild.verificationLevel]} ] ** `, true)

        .addField("👥memebers count ", `
...
client.on("message", message => {
    ...
    if (message.content.startsWith(prefix + "clear")) {
        ...
        if (!message.member.hasPermission('MANAGE_MESSAGES')) return message.reply('**⚠  you have to have manage messages on your role to do this command **');
        var msg;
        msg = parseInt();
...
//-------------------------------------تم اضافه البوت و خروجه
    ...
    client.channels.get("اي دي الشات الي تبي يجي فيه ان البوت دخل ").send(`**اسم بوتك** has been **added** :white_check_mark: from this server **(${guild.name})** , Server Owner 👑 **(${guild.owner.user.username})**`)
    });
    
    client.on("guildDelete", guild => {
    client.channels.get("اي دي الشات الي تبي يجي فيه ان البوت انطرد").send(`**اسم بوتك** has been **removed** :x: from this server **(${guild.name})** , Server Owner 👑 **(${guild.owner.user.username})**`)
    });
...
client.on('message', message => {
	...
	client.on('message', message => {
     ...
     .setColor('GREEN').setAuthor(`${message.author.username}'`, message.author.avatarURL).setDescription('``creating the colors |✅``')
	 });
	...
	if (message.content.startsWith("$del-colors")) {
		...
		role.delete()
			...
			message.channel.sendMessage({embed: new Discord.RichEmbed()
     .setColor('RED').setAuthor(`'${message.author.username}'`, message.author.avatarURL).setDescription('``deleting the colors |✅``')});
	}
	});
...
message.member.removeRole(message.guild.roles.find("name", "100"));
   ...
   .setDescription(`color has been updated`)
  message.channel.sendEmbed(embed);
	}
...
message.member.removeRole(message.guild.roles.find("name", "100"));
  ...
  if (message.content === '$colors') {
      if (!message.channel.guild) return;
    message.channel.sendFile('https://cdn.discordapp.com/attachments/397805021887987726/415142211865280512/colors.png','https://cdn.discordapp.com/attachments/397805021887987726/415142507249139713/colors.png','https://cdn.discordapp.com/attachments/397805021887987726/415142850250932234/colors.png');
  }
...
let embed = new Discord.RichEmbed()
     .setAuthor(message.author.username, message.author.avatarURL)
     .setDescription(' ✅ | massage has been sent ')
     .setThumbnail(message.author.avatarURL)
